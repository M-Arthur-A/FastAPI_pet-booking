...
class NoBookings(BookingException):
    status_code=status.HTTP_400_BAD_REQUEST
    detail="У данного пользователя отсутствуют бронирования"

class NoHotelAvailableForPeriod(BookingException):
    status_code=status.HTTP_400_BAD_REQUEST
    detail="Нет доступных гостиниц в выбранном регионе на эти даты"
